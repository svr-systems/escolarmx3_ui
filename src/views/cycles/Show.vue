        ...
        <v-col cols="12">
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                <v-col cols="12" md="6">
                  <VisVal label="Código" :value="item.code" />
                </v-col>
                <v-col cols="12" md="6">
                ...
                <v-col cols="12" md="3">
                  <VisVal
                    ...
                    :value="item.ops_start_at"
                  />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal label="Fin de operaciones" :value="item.ops_end_at" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal
                    label="Inicio del periodo lectivo"
                    :value="item.term_start_at"
                  />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal
                    label="Fin del periodo lectivo"
                    :value="item.term_end_at"
                  />
                </v-col>
              </v-row>
            </v-card-text>
